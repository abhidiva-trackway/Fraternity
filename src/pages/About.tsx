              ...
              >
                ...
                <div className="md:w-2/3">
                  ...
                  <p className="text-amber-900/90 mb-4 leading-relaxed">
                    ...
                    We are GR CELEBRATTIONS, your go-to team for catering and bulk sweet orders.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-amber-900/90 leading-relaxed">
                        From cozy gatherings to grand galas, GR CELEBRATTIONS turns moments into memories with exceptional food and flawless service.
                      </p>
                    </div>
